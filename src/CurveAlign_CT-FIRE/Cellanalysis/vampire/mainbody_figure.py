...
def mainbody(build_model, csv, outpth, clnum, numOfCoor, modelName, modelApply):
    ...
    if build_model:
        ...
        IDX, IDX_dist, vampire_model, _ = clusterSM_figure(outpth, score, bdpc, clnum, pcnum, vampire_model, build_model, None, None, modelName, modelApply)
        modelname = modelName
        ...
        for setidx, setpath in enumerate(setpaths):
            ...
            if experimental:
                IDX, IDX_dist, vampire_model, goodness = clusterSM_figure(outpth, score, bdpc, clnum, pcnum, vampire_model,
                ...
                IDX, IDX_dist, vampire_model, _ = clusterSM_figure(outpth, score, bdpc, clnum, pcnum, vampire_model,
                                                                   build_model, condition[setidx], setID[setidx],
                                                                   modelName, modelApply)
