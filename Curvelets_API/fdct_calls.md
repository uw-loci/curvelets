...
| `src/CurveAlign_CT-FIRE/ctFIRE/ctFeatures.m` | 71 | `fdct_wrapping(double(ISc),0)` | Forward transform per crop for feature evaluation |
| `src/CurveAlign_CT-FIRE/ctFIRE/ctFeatures.m` | 149 | `ifdct_wrapping(Ct,0)` | Inverse (partial) reconstruction per selected scales |
