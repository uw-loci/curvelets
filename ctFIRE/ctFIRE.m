...
%% CurveAlign callback check and path setup parameters
if nargin>0
    home
    CA_flag = 1;
...
%% Open File and Parameters buttons
...
%% Mode checkboxes and reset button
% button to reset gui
...
%% GUI panel to contain output checkboxes
...
%--------------------------------------------------------------------------
% callback function for the RUN button (imgRun)
        ...
        if openimg
            ...
            if openstack == 1
                ...
                if prlflag == 0
                    ...
                    %% parallel computing for a single stack
                    cP.widcon = widcon;
                    if cP.ws == 1 % process whole stack
                        cP.sselected = sslice;      % slices selected
