function[X0 E] = rand3dnet(NF,L,D2,rseed,plotflag)
...
%*                                                                           */
%
%Modified by Andy Stein
%University of Michigan
%Academic Advisor: Leonard Sander, Trachette Jackson
        ...
        if((h1 < h) & (h2 < h))
         ...
         if (dist2 < D2) % Collision!
           ...
           z1=zi1+(zi0-zi1)*tt;
                   ...
                   %bit added by andy for update to fiber structure
                   %F(k).v(end+1) = k;
...
for i=1:NF
   ...
   E(i,1:2) = [a(2*i-1) a(2*i)]; %added by andy
end
